...
export class MockApiService {
  ...
  async createOrganization(org: Partial<typeof organizationSettingsData.organizations[0]>): Promise<ApiResponse<typeof organizationSettingsData.organizations[0]>> {
    const newOrg = {
      ...org,
      id: (Math.max(...organizationSettingsData.organizations.map(o => parseInt(o.id))) + 1).toString(),
  ...
  async updateOrganization(id: string, org: Partial<typeof organizationSettingsData.organizations[0]>): Promise<ApiResponse<typeof organizationSettingsData.organizations[0]>> {
  ...
  async createUser(user: Partial<typeof usersData[0]>): Promise<ApiResponse<typeof usersData[0]>> {
    const newUser = {
      ...user,
  ...
  async updateUser(id: string, user: Partial<typeof usersData[0]>): Promise<ApiResponse<typeof usersData[0]>> {
  ...
  async getActivityTemplate(id: string): Promise<ApiResponse<typeof activityTemplatesData[0] | null>> {
