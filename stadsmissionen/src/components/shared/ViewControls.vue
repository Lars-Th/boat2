...
import { ChartPie, LayoutGrid, List, SlidersHorizontal } from 'lucide-vue-next';
  ...
  <div class="bg-background px-6">
    <div class="flex items-center justify-between">
      ...
      <div class="flex gap-2">
        <!-- View toggle bar -->
        <div v-if="showViewToggle" class="flex gap-1 rounded-md border border-border">
          <Button
        ...
        >
          ...
          <span class="bg-primary/10 text-primary px-2 py-1 rounded-md">
            ...
            <button class="ml-1 hover:text-primary/70" @click="clearFilter">×</button>
          </span>
        </div>
      </div>
    </div>
