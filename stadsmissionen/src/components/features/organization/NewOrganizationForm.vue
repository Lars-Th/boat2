      ...
      <form class="space-y-4" @submit.prevent="handleSubmit">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div class="space-y-2">
            ...
            <Input id="orgOrt" v-model="form.kontaktuppgifter.ort" placeholder="Göteborg" />
          </div>
        </div>
        ...
        <div class="flex gap-4 justify-end pt-4">
          <Button type="button" variant="outline" @click="handleCancel">Avbryt</Button>
          <Button type="submit" :disabled="!form.namn.trim() || isSubmitting" class="gap-2">
            <Plus class="h-4 w-4" />
