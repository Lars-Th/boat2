...
<template>
  <div class="w-full">
    ...
    <PageLayout
      ...
      description="Översikt av aktiviteter, deltagare och statistik"
    ...
    >
      ...
      <div v-if="isLoading" class="flex items-center justify-center py-12">
        <div class="text-center">
          ...
          ></div>
          <p class="text-muted-foreground">Laddar dashboard...</p>
        </div>
      </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div class="space-y-3">
                ...
                <div class="w-full bg-gray-200 rounded-full h-2">
                  <div
                    ...
                    :style="{
                      width: `${totalParticipants.value > 0 ? (ageStats.children / totalParticipants.value) * 100 : 0}%`,
                    }"
                  />
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div class="space-y-2">
                <div
                  v-for="type in (activityTypes || []).slice(0, 5)"
