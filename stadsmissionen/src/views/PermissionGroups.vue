...
import { Edit, Plus, Shield, Users } from 'lucide-vue-next';
...
const availablePermissions: Permission[] = [
  {
    id: 'users.view',
    name: 'Visa användare',
    description: 'Kan visa användarlistor',
    category: 'Användare',
  },
  {
    id: 'users.create',
    name: 'Skapa användare',
    description: 'Kan skapa nya användare',
    category: 'Användare',
  },
  {
    id: 'users.edit',
    name: 'Redigera användare',
    description: 'Kan redigera användaruppgifter',
    category: 'Användare',
  },
  {
    id: 'users.delete',
    name: 'Radera användare',
    description: 'Kan radera användare',
    category: 'Användare',
  },
  {
    id: 'customers.view',
    name: 'Visa kunder',
    description: 'Kan visa kundlistor',
    category: 'Kunder',
  },
  {
    id: 'customers.create',
    name: 'Skapa kunder',
    description: 'Kan skapa nya kunder',
    category: 'Kunder',
  },
  {
    id: 'customers.edit',
    name: 'Redigera kunder',
    description: 'Kan redigera kunduppgifter',
    category: 'Kunder',
  },
  {
    id: 'customers.delete',
    name: 'Radera kunder',
    description: 'Kan radera kunder',
    category: 'Kunder',
  },
  {
    id: 'orders.view',
    name: 'Visa arbetsorder',
    description: 'Kan visa arbetsorder',
    category: 'Arbetsorder',
  },
  {
    id: 'orders.create',
    name: 'Skapa arbetsorder',
    description: 'Kan skapa nya arbetsorder',
    category: 'Arbetsorder',
  },
  {
    id: 'orders.edit',
    name: 'Redigera arbetsorder',
    description: 'Kan redigera arbetsorder',
    category: 'Arbetsorder',
  },
  {
    id: 'orders.delete',
    name: 'Radera arbetsorder',
    description: 'Kan radera arbetsorder',
    category: 'Arbetsorder',
  },
  {
    id: 'system.admin',
  ...
  },
  {
    ...
    description: 'Kan ändra systeminställningar',
    category: 'System',
  },
  {
    id: 'reports.view',
    name: 'Visa rapporter',
    description: 'Kan visa rapporter',
    category: 'Rapporter',
  },
  {
    id: 'reports.export',
    name: 'Exportera rapporter',
    description: 'Kan exportera rapporter',
    category: 'Rapporter',
  },
];
      ...
      >
        ...
        <template #permissions="{ row }">
          <div class="flex flex-wrap gap-1 max-w-md">
            ...
            <Badge v-if="row.permissions.length > 3" variant="secondary" class="text-xs">
        ...
        <template #actions="{ row }">
          <div class="flex items-center gap-2">
            ...
            <Button size="sm" variant="outline" class="h-8 px-2" @click.stop="duplicateGroup(row)">
              Kopiera
            </Button>
          </div>
        </template>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Alla behörigheter som kan tilldelas grupper</CardDescription>
          </CardHeader>
          <CardContent>
            <div class="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Översikt över användarfördelning</CardDescription>
          </CardHeader>
          <CardContent>
            <div class="space-y-4">
              <div
