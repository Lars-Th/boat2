            ...
            <div class="space-y-2">
              ...
              <div class="space-y-2">
                <div class="flex flex-wrap gap-1 min-h-[32px] p-2 border rounded-md">
                  ...
                  <span
                    v-if="!formData.assignedTo?.length"
            ...
            <div class="space-y-2">
              ...
              <Select v-model="formData.status">
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Pågående">
                    Pågående
                  </SelectItem>
                  <SelectItem value="Pausad">
                    Pausad
                  </SelectItem>
                  <SelectItem value="Avslutad">
                    Avslutad
                  </SelectItem>
                </SelectContent>
              </Select>
          ...
          <Dialog v-model:open="isTaskModalOpen">
            ...
            <DialogContent class="max-w-md">
              ...
              <div class="space-y-4">
                <div class="space-y-2">
                  ...
                  <Select v-model="taskForm.type">
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="paus">
                        Paus
                      </SelectItem>
                      <SelectItem value="övrigt">
                        Övrigt
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div
                  v-if="taskForm.type !== 'paus' && taskForm.machine"
                  class="space-y-2"
                >
