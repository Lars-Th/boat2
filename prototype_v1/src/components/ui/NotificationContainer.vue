    ...
    >
      ...
      >
        <Button
          ...
          variant="destructive"
          class="text-xs"
          @click="() => handleConfirm(notification.id, true)"
        >
          {{ notification.options?.confirmText || 'Bekräfta' }}
        </Button>
        <Button
          size="sm"
          variant="outline"
          class="text-xs"
          @click="() => handleConfirm(notification.id, false)"
        >
          {{ notification.options?.cancelText || 'Avbryt' }}
        </Button>
      </div>
