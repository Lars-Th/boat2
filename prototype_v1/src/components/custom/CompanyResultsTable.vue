...
import { useProspectorStore, type Company } from '@/storages/prospectorStore'
import DataTable from '@/components/custom/DataTable.vue'
import { Badge } from '@/components/ui/badge'
import { Button } from '@/components/ui/button'
import { Building, Users, MapPin, ExternalLink } from 'lucide-vue-next'
...
const processedData = computed(() => {
  return searchResults.value.map((company: Company) => ({
    ...company,
        ...
        <template #cell-actions="{ row }">
          <div class="flex items-center gap-1">
            <Button
              ...
              variant="ghost"
              class="h-8 px-2"
              @click="handleViewDetails(row, $event)"
            >
            ...
            <Button
              ...
              variant="ghost"
              class="h-8 px-2"
              @click="handleCreateLead(row, $event)"
            >
              <Users class="h-3 w-3" />
            </Button>
          </div>
