...
import { Building2, User, Mail, Phone, Edit } from 'lucide-vue-next'
...
const openEditDialog = () => {
  if (contact.value) {
    dialogEditedContact.value = { ...contact.value }
    showEditDialog.value = true
  }
}
  ...
  >
    <DialogContent class="sm:max-w-[425px]">
      ...
      <div class="grid gap-4 py-4">
        ...
        <div class="grid grid-cols-4 items-center gap-4">
          <label for="isMainContact" class="text-right">
            Huvudkontakt
          </label>
          <div class="col-span-3 flex items-center">
            <input
              ...
              class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
            />
            <label for="isMainContact" class="ml-2 text-sm text-gray-700">
      ...
      <DialogFooter>
        <Button type="submit" @click="saveDialogChanges">Spara</Button>
      </DialogFooter>
    </DialogContent>
  </Dialog>
</template> 