...
<template>
  <PageLayout
    title="Ny deltagare"
    breadcrumbs="Dashboard / Deltagare / Ny deltagare"
  >
            ...
            <div class="space-y-2">
              ...
              <Input
                ...
                :class="{
                  'border-red-500':
                    form.personnummer &&
                    !validatePersonnummer(form.personnummer),
                }"
              />
              <p
                v-if="
                  form.personnummer && !validatePersonnummer(form.personnummer)
                "
